...
export interface BatchSettlementTronSchemeServerConfig {
  storage?: ChannelStorage;
  receiverAuthorizerSigner?: TronAuthorizerSigner;
...
export class BatchSettlementServerScheme implements SchemeNetworkServer {
  ...
  private readonly receiverAuthorizerSigner: TronAuthorizerSigner | undefined;
   ...
   */
  constructor(receiverAddress: string, config?: BatchSettlementTronSchemeServerConfig) {
  ...
  ): Promise<void> => handleEnrichPaymentRequiredResponse(this, ctx);
  ...
  /**
   * Injects batched-specific fields into the payment requirements returned to the client.
   *
  ...
  private defaultMoneyConversion(amount: number, network: Network): AssetAmount {
    ...
    return {
      ...
      extra: { name: assetInfo.name, version: assetInfo.version },
    };
  }
}
