# `@bankofai/x402-aptos` [![npm version](https://img.shields.io/npm/v/%40bankofai%2Fx402-aptos.svg)](https://www.npmjs.com/package/@bankofai/x402-aptos)
...
```bash
npm install @bankofai/x402-aptos
# or
pnpm add @bankofai/x402-aptos
```
...
import { ExactAptosScheme } from "@bankofai/x402-aptos/exact/client";
