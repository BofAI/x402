...
import type { PaymentRequirements, PaymentPayload } from "@bankofai/x402-core/types";
import type { PaymentPayloadV1, PaymentRequirementsV1 } from "@bankofai/x402-core/types/v1";
