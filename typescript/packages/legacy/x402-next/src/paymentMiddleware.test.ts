...
import { exact } from "@bankofai/x402-legacy/schemes";
import { findMatchingRoute, findMatchingPaymentRequirements } from "@bankofai/x402-legacy/shared";
import { getPaywallHtml } from "@bankofai/x402-legacy/paywall";
import {
  FacilitatorConfig,
  Network,
...
import { useFacilitator } from "@bankofai/x402-legacy/verify";
import { paymentMiddleware } from "./index";

// Mock dependencies
vi.mock("@bankofai/x402-legacy/verify", () => ({
  useFacilitator: vi.fn(),
}));

vi.mock("@bankofai/x402-legacy/paywall", () => ({
  getPaywallHtml: vi.fn(),
}));

vi.mock("@bankofai/x402-legacy/shared", async importOriginal => {
