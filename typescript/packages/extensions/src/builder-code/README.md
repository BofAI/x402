...
Part of [`@bankofai/x402-extensions`](../README.md). Import from `@bankofai/x402-extensions/builder-code`.
...
```typescript
import { parseBuilderCodeSuffixFromCalldata } from "@bankofai/x402-extensions/builder-code";
...
- [`@bankofai/x402-extensions` overview](../README.md)
