...
import { x402HTTPResourceServer, x402ResourceServer } from "@bankofai/x402-core/server";
 ...
 * no bypass to fix here, independent of whether `@bankofai/x402-core`'s regex has
 * the dotAll flag.
 *
