...
import { x402HTTPResourceServer } from "@bankofai/x402-core/server";
...
export function paymentProxyFromHTTPServer(
  ...
  if (checkIfBazaarNeeded(httpServer.routes) && !httpServer.server.hasExtension("bazaar")) {
    bazaarPromise = import(/* webpackIgnore: true */ "@bankofai/x402-extensions/bazaar")
...
export type { PaywallProvider, PaywallConfig, RouteConfig } from "@bankofai/x402-core/server";
