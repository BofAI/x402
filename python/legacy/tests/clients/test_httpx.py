...
from bankofai.x402.clients.httpx import HttpxHooks, x402_payment_hooks, x402HttpxClient
from bankofai.x402.clients.base import (
    PaymentError,
)
from bankofai.x402.types import PaymentRequirements, x402PaymentRequiredResponse
...
async def test_on_response_payment_flow(hooks, payment_requirements):
    ...
    with patch("bankofai.x402.clients.httpx.AsyncClient", return_value=mock_client):
        result = await hooks.on_response(response)
