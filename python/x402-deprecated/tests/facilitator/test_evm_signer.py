...
from bankofai.x402_deprecated.signers.facilitator import EvmFacilitatorSigner
...
async def test_evm_verify_typed_data(mock_evm_private_key):
    ...
    from bankofai.x402_deprecated.abi import PAYMENT_PERMIT_EIP712_DOMAIN_TYPE
