...
from bankofai.x402_deprecated.mechanisms.tron.exact_gasfree.facilitator import (
...
class TestGasFreeFacilitator:
    ...
    async def test_verify_calls_signer_with_correct_data(
        ...
        with patch("bankofai.x402_deprecated.tokens.TokenRegistry.find_by_address") as mock_find:
