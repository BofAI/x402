...
from bankofai.x402_deprecated.mechanisms.tron.exact_gasfree.client import ExactGasFreeClientMechanism
from bankofai.x402_deprecated.types import FeeInfo, PaymentRequirements, PaymentRequirementsExtra
...
@pytest.fixture
def mock_api_client():
    with patch("bankofai.x402_deprecated.mechanisms.tron.exact_gasfree.client.GasFreeAPIClient") as mock:
...
class TestGasFreeClient:
    ...
    async def test_insufficient_balance(self, mock_signer, nile_requirements, mock_api_client):
        from bankofai.x402_deprecated.exceptions import InsufficientGasFreeBalance
    ...
    async def test_not_activated(self, mock_signer, nile_requirements, mock_api_client):
        from bankofai.x402_deprecated.exceptions import GasFreeAccountNotActivated
