...
if TYPE_CHECKING:
    from bankofai.x402_deprecated.facilitator.facilitator_client import FacilitatorClient
...
class X402Server:
    ...
    def _register_default_tron_mechanisms(self) -> None:
        ...
        from bankofai.x402_deprecated.mechanisms.tron.exact_permit import ExactPermitTronServerMechanism
            ...
            if permit_reqs:
                ...
                for req in permit_reqs:
                    ...
                    if req.extra is None:
                        from bankofai.x402_deprecated.types import PaymentRequirementsExtra
    ...
    def create_payment_required_response(
        ...
        from bankofai.x402_deprecated.utils import generate_payment_id
