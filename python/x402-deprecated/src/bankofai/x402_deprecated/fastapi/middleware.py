...
from bankofai.x402_deprecated.encoding import decode_payment_payload, encode_payment_payload
from bankofai.x402_deprecated.server import ResourceConfig, X402Server
from bankofai.x402_deprecated.types import PaymentPayload, PaymentRequirements

if TYPE_CHECKING:
    from bankofai.x402_deprecated.utils.tx_verification import TransactionVerificationResult
...
class X402Middleware:
    ...
    def protect(
        ...
        from bankofai.x402_deprecated.tokens import TokenRegistry
    ...
    async def _verify_transaction_on_chain(
        ...
        Returns:
            TransactionVerificationResult
        """
        from bankofai.x402_deprecated.utils.tx_verification import (
            TransactionVerificationResult,
