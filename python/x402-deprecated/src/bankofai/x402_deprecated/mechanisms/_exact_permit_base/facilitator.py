...
from bankofai.x402_deprecated.abi import get_payment_permit_eip712_types
from bankofai.x402_deprecated.address import AddressConverter
...
from bankofai.x402_deprecated.utils import convert_permit_to_eip712_message, payment_id_to_bytes
...
class BaseExactPermitFacilitatorMechanism(FacilitatorMechanism):
    ...
    async def _verify_signature(
        ...
        from bankofai.x402_deprecated.abi import PAYMENT_PERMIT_PRIMARY_TYPE
