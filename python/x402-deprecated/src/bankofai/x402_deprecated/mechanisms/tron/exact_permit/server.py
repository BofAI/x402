...
from bankofai.x402_deprecated.mechanisms._exact_permit_base.server import BaseExactPermitServerMechanism
from bankofai.x402_deprecated.types import KIND_MAP
...
class ExactPermitTronServerMechanism(BaseExactPermitServerMechanism):
    ...
    def _get_verifying_contract(self, permit_address: str) -> str:
        ...
        from bankofai.x402_deprecated.utils.address import tron_address_to_evm
