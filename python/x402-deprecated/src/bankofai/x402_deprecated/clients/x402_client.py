...
if TYPE_CHECKING:
    from bankofai.x402_deprecated.clients.token_selection import TokenSelectionStrategy
...
class X402Client:
    ...
    async def select_payment_requirements(
        ...
        if self._token_strategy:
            ...
            from bankofai.x402_deprecated.clients.token_selection import DefaultTokenSelectionStrategy
