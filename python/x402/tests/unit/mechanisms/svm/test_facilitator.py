...
from bankofai.x402.mechanisms.svm import (
    SOLANA_DEVNET_CAIP2,
    SOLANA_MAINNET_CAIP2,
    USDC_DEVNET_ADDRESS,
)
from bankofai.x402.mechanisms.svm.exact import ExactSvmFacilitatorScheme
from bankofai.x402.schemas import PaymentPayload, PaymentRequirements, ResourceInfo, VerifyResponse
...
class TestDuplicateSettlementCache:
    ...
    def test_shared_cache_blocks_cross_version_duplicates(self):
        ...
        from bankofai.x402.mechanisms.svm.exact.v1.facilitator import (
            ExactSvmSchemeV1 as ExactSvmFacilitatorSchemeV1,
        )
        from bankofai.x402.mechanisms.svm.settlement_cache import SettlementCache
        from bankofai.x402.schemas.v1 import PaymentPayloadV1, PaymentRequirementsV1
