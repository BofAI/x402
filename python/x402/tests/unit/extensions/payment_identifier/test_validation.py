...
from bankofai.x402.extensions.payment_identifier.utils import generate_payment_id
from bankofai.x402.extensions.payment_identifier.validation import PaymentIdentifierValidationResult
from bankofai.x402.schemas.payments import PaymentPayload, PaymentRequirements
...
def create_extension_with_id(id: str | None = None, required: bool = False) -> dict:
    ...
    if id:
        from bankofai.x402.extensions.payment_identifier.client import (
