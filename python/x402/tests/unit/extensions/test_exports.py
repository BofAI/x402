"""Tests to verify that all __all__ exports from bankofai.x402.extensions are importable.
...
from bankofai.x402 import extensions
...
class TestExtensionExports:
    ...
    def test_all_exports_are_importable(self) -> None:
        """Test that every item in __all__ can be imported from bankofai.x402.extensions."""
    ...
    def test_validation_result_imports(self) -> None:
        ...
        from bankofai.x402.extensions import (
    ...
    def test_import_all_star(self) -> None:
        """Test that 'from bankofai.x402.extensions import *' works correctly."""
        # Create a new namespace
        namespace = {}
        # Execute import * in that namespace
        exec("from bankofai.x402.extensions import *", namespace)
