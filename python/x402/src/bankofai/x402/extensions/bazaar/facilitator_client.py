...
if TYPE_CHECKING:
    from bankofai.x402.http.facilitator_client import HTTPFacilitatorClient
...
class BazaarDiscoveryExtension:
    ...
    def list_resources(
        ...
        Example:
            ...
            from bankofai.x402.extensions.bazaar import with_bazaar
...
def with_bazaar(client: HTTPFacilitatorClient) -> BazaarExtendedClient:
    ...
    Example:
        ...
        from bankofai.x402.extensions.bazaar import with_bazaar, ListDiscoveryResourcesParams
