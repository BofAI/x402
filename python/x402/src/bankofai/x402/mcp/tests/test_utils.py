...
from bankofai.x402.mcp.types import MCPToolResult
from bankofai.x402.mcp.utils import (
...
from bankofai.x402.schemas import PaymentPayload, PaymentRequired, SettleResponse
...
def test_create_payment_required_error():
    ...
    from bankofai.x402.mcp import create_payment_required_error
    from bankofai.x402.schemas import PaymentRequired
...
def test_extract_payment_required_from_error():
    ...
    from bankofai.x402.mcp import extract_payment_required_from_error
...
def test_attach_payment_response_to_meta_existing_meta():
    ...
    from bankofai.x402.mcp.utils import attach_payment_response_to_meta
...
def test_is_payment_required_error():
    ...
    from bankofai.x402.mcp.types import PaymentRequiredError
    from bankofai.x402.mcp.utils import is_payment_required_error
...
def test_convert_mcp_result():
    ...
    from bankofai.x402.mcp.utils import convert_mcp_result
