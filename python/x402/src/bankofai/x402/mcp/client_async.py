...
class x402MCPClient:
    ...
    Example:
        ```python
        from bankofai.x402 import x402ClientAsync
        from bankofai.x402.mcp import x402MCPClient
...
def wrap_mcp_client_with_payment(
    ...
    *,
    ...
    Example:
        ```python
        from bankofai.x402 import x402ClientAsync
        from bankofai.x402.mcp import wrap_mcp_client_with_payment
...
def wrap_mcp_client_with_payment_from_config(
    ...
    *,
    ...
    Example:
        ```python
        from bankofai.x402.mcp import wrap_mcp_client_with_payment_from_config
        from bankofai.x402.mechanisms.evm.exact import ExactEvmClientScheme
