...
Quick Start (Async - Recommended):
    ```python
    from bankofai.x402 import x402Client, x402ResourceServer, x402Facilitator
...
Quick Start (Sync):
    ```python
    from bankofai.x402 import x402ClientSync, x402ResourceServerSync, x402FacilitatorSync
