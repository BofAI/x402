# @bankofai/x402-fetch Example Client

Example client demonstrating how to use `@bankofai/x402-fetch` to make HTTP requests to endpoints protected by the x402 payment protocol.
