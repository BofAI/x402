...
import { x402Client, wrapAxiosWithPayment, x402HTTPClient } from "@bankofai/x402-axios";
...
/**
 * Example demonstrating how to use @bankofai/x402-axios to make requests to x402-protected endpoints.
 *
