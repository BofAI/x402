 ...
 *
 * Offers both USDT and USDD on `tron:0xcd8690dc`. Both are permit2 tokens (no ERC-3009);
...
// Switch to "tron:0x2b6653dc" for production (REAL FUNDS). USDT/USDD are registered
