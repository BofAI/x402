...
import { x402ResourceServer, HTTPFacilitatorClient, ResourceConfig } from "@bankofai/x402-core/server";
 ...
 * without using the pre-built middleware packages like @bankofai/x402-express.
 *
