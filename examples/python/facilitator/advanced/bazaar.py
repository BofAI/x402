...
from bankofai.x402.mechanisms.evm.exact.facilitator import ExactEvmScheme, ExactEvmSchemeConfig
from bankofai.x402.mechanisms.svm import FacilitatorKeypairSigner
from bankofai.x402.mechanisms.svm.exact.facilitator import ExactSvmScheme
...
async def verify(request: VerifyRequest):
    ...
    """
    try:
        from bankofai.x402.schemas import PaymentRequirements, parse_payment_payload
