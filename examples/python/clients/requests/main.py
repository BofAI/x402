...
from bankofai.x402 import bankofai.x402ClientSync
from bankofai.x402.http import bankofai.x402HTTPClientSync
from bankofai.x402.http.clients import bankofai.x402_requests
